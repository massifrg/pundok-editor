...
import {
  ...
  PandocAttrExtension,
  PandocAttrOptions,
  PandocEditorUtilsExtension,
  PandocEditorUtilsOptions,
...
export interface PandocOptions {
  ...
  customPaste: false;
  pandocEditorUtils: Partial<PandocEditorUtilsOptions> | false;
  textTransform: false;
...
export const Pandoc = Document.extend<PandocOptions>({
  ...
  addExtensions() {
    const defs: {
      ...
      { name: 'pandocEditorUtils', object: PandocEditorUtilsExtension },
