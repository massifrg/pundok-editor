...
import { NODE_NAME_IMAGE, SK } from '../../common';
...
export const Image = Node.create<ImageOptions>({
  ...
  addCommands() {
    return {
      setImage: (options) => asTiptapCommand(setImageCommand(options)),
      fixImageSrc: () => asTiptapCommand(fixImageSrc(false)),
      fixAllImagesSrc: () => asTiptapCommand(fixImageSrc(true)),
    };
  },
