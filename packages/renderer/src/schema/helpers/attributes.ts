...
const NODE_OR_MARK_ATTRIBUTES: Record<string, NodeOrMarkAttribute> = {
  ...
  /** used in notes */
  mathType: { editable: true, visible: true, order: 104 },
};
...
export const PANDOC_OUTPUT_FORMATS: string[][] = [
  ...
  ['html', 'HTML, i.e. HTML5/XHTML polyglot markup', 'language_html'],
  ['html5', 'HTML, i.e. HTML5/XHTML polyglot markup', 'language_html'],
  ...
  ['latex', 'LaTeX'],
  ['man', 'roff man'],
  ['markdown', 'Pandoc’s Markdown', 'language_markdown'],
