// derived from https://github.com/ProseMirror/prosemirror-search/blob/main/src/query.ts
...
export class SearchQuery {
  ...
  readonly filter: SearchResultFilter | null;
  ...
  constructor(config: {
    ...
    this.filter = config.filterResult || null;
